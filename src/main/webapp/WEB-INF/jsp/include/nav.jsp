...
<body>
		<div class="left-box" align="center">
				<div class="nav-container">
					<ul class="menu">
						<h1>HabitMaker</h1>
						<li><a href="#" onclick="main()"><i class="bi bi-house-fill"></i> 홈</a></li>
						<li><a href="#" onclick="calendar()"><i class="bi bi-calendar"></i> 캘린더</a></li>
...
<script>
	...
	function main() {
		  window.location.href = "/todo/main-view?dueDate=" + dateString;
		}
	
	function calendar() {
		  window.location.href = "/todo/calendar-view?dueDate=" + dateString;
		}
